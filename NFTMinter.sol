...
abstract contract RoyaltiesAddon is ERC721Enumerable {
...
contract CodeEater is Ownable, RoyaltiesAddon, ERC2981 {
    using SafeMath for uint256;
    using Counters for Counters.Counter;
    using Strings for uint256;

    uint256 public MAX_ELEMENTS = 35;
    ...
    constructor(string memory baseURI) ERC721("Code Eater", "CER"){
        setBaseURI(baseURI);
    }
